...
export const projectInfos: ProjectInfo[] = [
  ...
  },
  {
    ...
    description: "The primary objective of this design brief is to develop a captivating video that educates participants about the critical importance of sun protection and proper sunscreen usage, with a spotlight on Anessa's innovative sunscreen products ",
    slug: "3d",
    tools: "After effect",
    duration: "3 weeks",
    projectPreview: "",
    type: "Motion",
    category: "Personal Project",
    video: "/images/we earth/ Video template",
    intro: "UX Case Study",
    finalProduct: [{ video: "/images/we earth/ Video template" },
